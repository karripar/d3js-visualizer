...
export default function LandingPage() {
  return (
    <main className="min-h-screen bg-zinc-950 relative overflow-hidden">
      ...
      {/* floating brand badge -- removed for now --*/}
      ...
      <section className="relative z-10 px-6 pt-24 pb-12 sm:pt-32 sm:pb-16 max-w-4xl mx-auto text-center text-white">
        ...
        <div className="mx-auto w-fit">
          <span className="text-3xl sm:text-6xl font-black tracking-tight bg-clip-text text-transparent bg-linear-to-r from-blue-400 via-fuchsia-400 to-purple-400 drop-shadow-[0_0_20px_rgba(99,102,241,0.25)]">
            Aspect
          </span>
        </div>
